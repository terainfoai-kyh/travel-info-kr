...
export const CITY_TRANSLATIONS = {
  ko: { '서울': '서울', '부산': '부산', '제주': '제주', '수원': '수원', '경주': '경주', '강릉': '강릉', '전주': '전주', '여수': '여수', '속초': '속초', '인천': '인천', '대구': '대구', '대전': '대전', '평택': '평택', '서귀포': '서귀포', '거제': '거제', '괴산': '괴산', '제천': '제천', '단양': '단양', '보은': '보은', '옥천': '옥천', '영동': '영동', '진천': '진천', '음성': '음성', '증평': '증평', '포항': '포항', '안동': '안동', '순천': '순천', '통영': '통영', '남해': '남해', '춘천': '춘천', '양양': '양양', '평창': '평창', '군산': '군산', '익산': '익산', '울릉도': '울릉도', '울릉': '울릉' },
  en: { '서울': 'Seoul', '부산': 'Busan', '제주': 'Jeju', '수원': 'Suwon', '경주': 'Gyeongju', '강릉': 'Gangneung', '전주': 'Jeonju', '여수': 'Yeosu', '속초': 'Sokcho', '인천': 'Incheon', '대구': 'Daegu', '대전': 'Daejeon', '평택': 'Pyeongtaek', '서귀포': 'Seogwipo', '거제': 'Geoje', '괴산': 'Goesan', '제천': 'Jecheon', '단양': 'Danyang', '보은': 'Boeun', '옥천': 'Okcheon', '영동': 'Yeongdong', '진천': 'Jincheon', '음성': 'Eumseong', '증평': 'Jeungpyeong', '포항': 'Pohang', '안동': 'Andong', '순천': 'Suncheon', '통영': 'Tongyeong', '남해': 'Namhae', '춘천': 'Chuncheon', '양양': 'Yangyang', '평창': 'Pyeongchang', '군산': 'Gunsan', '익산': 'Iksan', '울릉도': 'Ulleungdo', '울릉': 'Ulleungdo' },
  ja: { '서울': 'ソウル', '부산': '釜山', '제주': '済州', '수원': '水原', '경주': '慶州', '강릉': '江陵', '전주': '全州', '여수': '麗水', '속초': '束草', '인천': '仁川', '대구': '大邱', '대전': '大田', '평택': '平沢', '서귀포': '西帰浦', '거제': '巨済', '괴산': '槐山', '제천': '堤川', '단양': '丹陽', '보은': '報恩', '옥천': '沃川', '영동': '永同', '진천': '鎮川', '음성': '陰城', '증평': '曽坪', '포항': '浦項', '안동': '安東', '순천': '順天', '통영': '統営', '남해': '南海', '춘천': '春川', '양양': '襄陽', '평창': '平昌', '군산': '群山', '익산': '益山', '울릉도': '鬱陵島', '울릉': '鬱陵' },
  zh: { '서울': '首尔', '부산': '釜山', '제주': '济州', '수원': '水原', '경주': '庆州', '강릉': '江陵', '전주': '全州', '여수': '丽水', '속초': '束草', '인천': '仁川', '대구': '大邱', '대전': '大田', '평택': '平泽', '서귀포': '西归浦', '거제': '巨济', '괴산': '槐山', '제천': '堤川', '단양': '丹阳', '보은': '报恩', '옥천': '沃川', '영동': '永同', '진천': '镇川', '음성': '阴城', '증평': '曾坪', '포항': '浦项', '안동': '安东', '순천': '顺天', '통영': '统营', '남해': '南海', '춘천': '春川', '양양': '襄阳', '평창': '平昌', '군산': '群山', '익산': '益山', '울릉도': '郁陵岛', '울릉': '郁陵' },
  zht: { '서울': '首爾', '부산': '釜山', '제주': '濟州', '수원': '水原', '경주': '慶州', '강릉': '江陵', '전주': '全州', '여수': '麗水', '속초': '束草', '인천': '仁川', '대구': '大邱', '대전': '大田', '평택': '平澤', '서귀포': '西歸浦', '거제': '巨濟', '괴산': '槐山', '제천': '堤川', '단양': '丹陽', '보은': '報恩', '옥천': '沃川', '영동': '永同', '진천': '鎮川', '음성': '陰城', '증평': '曾坪', '포항': '浦項', '안동': '安東', '순천': '順天', '통영': '統營', '남해': '南海', '춘천': '春川', '양양': '襄陽', '평창': '平昌', '군산': '群山', '익산': '益山', '울릉도': '鬱陵島', '울릉': '鬱陵' }
};
