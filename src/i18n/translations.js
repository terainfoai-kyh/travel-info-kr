...
export const TRANSLATIONS = {
  ko: {
    ...
    privacyPolicyTitle: '개인정보처리방침 (Privacy Policy)',
  ...
  en: {
    ...
    navMap: 'Google Map',
    aiLifestyleTitle: 'AI Travel Lifestyle Guide',
    aiLifestyleSub: 'Analyzes region, weather, age & gender to recommend optimal food & outfit choices.',
    foodTabLabel: '🍱 AI Food & Dining',
    outfitTabLabel: '👔 Weather Outfit',
  ...
  ja: {
    ...
    navMap: 'Googleマップ',
    aiLifestyleTitle: 'AI 旅行ライフスタイルガイド',
    aiLifestyleSub: '地域・気候・年齢・性別条件を分析し、最適なグルメとコーディネートをご提案します。',
    foodTabLabel: '🍱 AI おすすめグルメ',
    outfitTabLabel: '👔 天気服装コーデ',
    langKo: '韓国語 (KO)',
    langEn: '英語 (EN)',
    langJa: '日本語 (JA)',
