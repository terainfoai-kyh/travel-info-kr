...
export function extractLocationKeyword(prompt = '', fallbackToDefault = false) {
  ...
  const CITY_MAP = [
    ...
    { keys: ['제주', 'jeju', '済州', '济州', '우도', '가파도', '마라도', '비양도', '추자도', '애월', '협재', '서귀포', '성산', '중문', '함덕', '올레', '한담', '비자림', '섭지코지', '도두동', '한라산', '산방산', '표선', '월정리'], city: '제주' },
    ...
    { keys: ['거제', 'geoje', '巨済', '외도', '지심도', '내도', '바람의언덕', '매미성', '구조라', '신선대', '정글돔', '학동몽돌'], city: '거제' },
    { keys: ['남해', 'namhae', '독일마을', '다랭이마을', '보리암', '금산산장', '미조항', '상주은모래'], city: '남해' },
    { keys: ['포항', 'pohang', '호미곶', '스페이스워크', '영일대', '구룡포', '이가리닻', '칠포', '월포'], city: '포항' },
    { keys: ['안동', 'andong', '하회마을', '월영교', '도산서원', '만휴정', '안동찜닭'], city: '안동' },
    { keys: ['단양', 'danyang', '도담삼봉', '만천하', '스카이워크', '고수동굴', '카페산', '패러글라이딩'], city: '단양' },
    ...
    { keys: ['순천', 'suncheon', '순천만', '국가정원', '낙안읍성', '드라마촬영장', '와온해변'], city: '순천' },
    ...
    { keys: ['평창', 'pyeongchang', '대관령', '양떼목장', '월정사', '삼양목장', '알펜시아', '봉평'], city: '평창' },
    { keys: ['영월', 'yeongwol', '청령포', '선돌', '한반도지형', '별마로천문대', '동강'], city: '영월' },
    { keys: ['정선', 'jeongseon', '하이원', '병방치', '화암동굴', '아우라지', '레일바이크'], city: '정선' },
    { keys: ['문경', 'mungyeong', '문경새재', '오미자테마', '짚라인', '에코랄라', '가은역'], city: '문경' },
    { keys: ['거창', 'geochang', 'Y자형출렁다리', '우두산', '수승대', '창포원', '월성계곡'], city: '거창' },
    { keys: ['밀양', 'miryang', '영남루', '위양지', '얼음골', '트윈터널', '표충사'], city: '밀양' },
    { keys: ['사천', 'sacheon', '바다케이블카', '삼천포', '비토섬', '항공우주박물관'], city: '사천' },
    { keys: ['김해', 'gimhae', '가야테마파크', '연지공원', '수로왕릉', '낙동강레일파크'], city: '김해' },
    { keys: ['하동', 'hadong', '화개장터', '최참판댁', '쌍계사', '십리벚꽃길', '삼성궁'], city: '하동' },
    { keys: ['구례', 'gurye', '화엄사', '산동산수유', '사성암', '노고단', '지리산치즈랜드'], city: '구례' },
    { keys: ['남원', 'namwon', '광한루원', '지리산뱀사골', '춘향테마파크'], city: '남원' },
    { keys: ['고창', 'gochang', '고인돌', '선운사', '학원농장', '청보리밭', '읍성'], city: '고창' },
    { keys: ['부안', 'buan', '채석강', '변산반도', '내소사', '격포해수욕장', '모항'], city: '부안' },
