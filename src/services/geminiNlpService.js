...
1. Recommend 2 genuinely trendy, authentic, non-repeating spots per day (popular cafes, K-POP spots, scenic photo zones, local delicacies, night views).
...
// Local Fallback Itinerary Generator with 6 Unique Non-Repeating Spots & Rich Storytelling
export function generateLocalFallbackItinerary(rawPrompt = '', targetCity = '서울', days = 3, lang = 'ko') {
  ...
  const SAMPLE_SPOTS_MAP = {
    ...
    '제주': [
      ...
      // Day 3
      { name: '사려니숲길', theme: '삼나무 향기 가득한 신비로운 숲길', desc: '울창한 삼나무가 하늘 높이 솟아있는 힐링 산책로로, 맑은 피톤치드를 마시며 고요한 자연을 누릴 수 있습니다.', cat: '힐링숲', photo: '📸 삼나무 숲길 사이로 내리는 햇살 샷', sig: '🌲 숲속 힐링 트레킹', time: '오전 10:00', lat: 33.4077, lng: 126.6432 },
  ...
  const DAILY_THEMES = {
    ...
    '제주': [
      { theme: '1일차: 서쪽 바다의 낭만과 에메랄드 해변', transit: '제주 서부 해안도로 순환 버스 및 렌터카 이동', food: { dishName: '애월 흑돼지 근고기 & 해물라면', description: '바다 노을을 바라보며 멜젓에 찍어 먹는 도톰한 육즙의 향연' } },
      { theme: '2일차: 동쪽 세계자연유산과 서귀포 야시장', transit: '동부 번영로 급행 버스 이용', food: { dishName: '성산 은갈치조림 & 올레시장 마농치킨', description: '매콤달콤한 갈치조림과 마늘 향 가득한 제주 명물 치킨' } },
      { theme: '3일차: 피톤치드 삼나무 숲과 웅장한 주상절리', transit: '5.16도로 숲길 순환 노선 이용', food: { dishName: '보말칼국수 & 전복죽', description: '제주 바다의 깊은 풍미를 담은 든든한 힐링 한 그릇' } }
    ],
    '부산': [
  ...
  return {
    ...
    summary: `VORA AI 매거진이 제안하는 ${city} ${days}일 트렌디 여행 코스입니다. 1일차 고궁/한옥부터 2일차 성수동 핫플/남산 선셋, 3일차 K-POP/한강 힐링까지 최고의 인생샷 명소로 엄선되었습니다. ✨`,
    dailySchedules: finalizedSchedules,
    spots: flatSpots,
