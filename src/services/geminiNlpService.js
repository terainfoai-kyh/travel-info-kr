...
export function extractLocationKeyword(prompt = '', fallbackToDefault = false) {
  ...
  const CITY_MAP = [
    ...
    { keys: ['울릉도', '울릉', '독도', 'ulleung', 'dokdo', '나리분지', '관음도', '행남해안산책로', '독도전망대'], city: '울릉' },
    { keys: ['진도', 'jindo', '운림산방', '진도타워', '세방낙조', '신비의바닷길'], city: '진도' },
    { keys: ['완도', 'wando', '청산도', '완도타워', '명사십리', '보길도'], city: '완도' },
    { keys: ['신안', 'shinan', '퍼플섬', '반월박지도', '천사대교', '짱뚱어다리', '홍도', '흑산도'], city: '신안' },
    { keys: ['강화도', '강화', 'ganghwa', '마니산', '전등사', '동막해변', '조양방직'], city: '인천' },
    { keys: ['수원', 'suwon', '水原', '행궁동', '화성행궁', '광교', '방화수류정', '행궁', '화성', '팔달문', '장안문', '행리단길', '수원화성', '수원갈비', '플라잉수원', '통닭거리'], city: '수원' },
    { keys: ['부산', 'busan', '釜山', '해운대', '광안리', '자갈치', '남포동', '영도', '송도', '블루라인', '광안대교', '해동용궁사', '흰여울', '기장', '서면', '센텀', '다대포', '태종대'], city: '부산' },
    { keys: ['제주', 'jeju', '済州', '济州', '애월', '협재', '서귀포', '성산', '중문', '함덕', '올레', '한담', '비자림', '섭지코지', '도두동', '한라산', '우도', '산방산', '표선', '월정리'], city: '제주' },
    { keys: ['경주', 'gyeongju', '慶州', '황리단길', '불국사', '보문', '첨성대', '동궁과월지', '대릉원', '안압지', '석굴암', '보문단지'], city: '경주' },
    { keys: ['창원', 'changwon', '昌原', '마산', '진해', '마산어시장', '용지호수', '상국상가', '창원수목원', '군항제', '여좌천'], city: '창원' },
    { keys: ['통영', 'tongyeong', '統營', '동피랑', '서피랑', '통영케이블카', '이순신공원', '디피랑', '충무김밥', '미륵산', '강구안'], city: '통영' },
    { keys: ['강릉', 'gangneung', '江陵', '안목', '경포대', '초당', '주문진', '정동진', '하슬라', '선교장', '오죽헌'], city: '강릉' },
    { keys: ['속초', 'sokcho', '束草', '설악산', '아바이마을', '중앙시장', '동명항', '영금정', '양양', '낙산사', '서피비치'], city: '속초' },
    { keys: ['전주', 'jeonju', '全州', '한옥마을', '객리단길', '경기전', '풍남문', '전동성당', '덕진공원'], city: '전주' },
    { keys: ['여수', 'yeosu', '麗水', '돌산', '오동도', '낭만포차', '해상케이블카', '향일암', '예술의온도', '이순신광장'], city: '여수' },
    { keys: ['거제', 'geoje', '巨済', '바람의언덕', '매미성', '외도', '구조라', '신선대', '정글돔', '학동몽돌'], city: '거제' },
    { keys: ['남해', 'namhae', '독일마을', '다랭이마을', '보리암', '금산산장', '미조항'], city: '남해' },
    { keys: ['포항', 'pohang', '호미곶', '스페이스워크', '영일대', '구룡포', '이가리닻'], city: '포항' },
    { keys: ['안동', 'andong', '하회마을', '월영교', '도산서원', '만휴정', '안동찜닭'], city: '안동' },
    { keys: ['단양', 'danyang', '도담삼봉', '만천하', '스카이워크', '고수동굴'], city: '단양' },
    { keys: ['공주', 'gongju', '무령왕릉', '공산성', '부여', '궁남지', '정림사지'], city: '공주' },
    { keys: ['군산', 'gunsan', '선유도', '철길마을', '이성당', '초원사진관', '근대역사박물관'], city: '군산' },
    { keys: ['춘천', 'chuncheon', '소양강', '닭갈비골목', '레고랜드', '남이섬', '삼악산'], city: '춘천' },
    { keys: ['가평', 'gapyeong', '자라섬', '아침고요수목원', '청평', '쁘띠프랑스'], city: '가평' },
    { keys: ['담양', 'damyang', '죽녹원', '메타세콰이어', '관방제림', '소쇄원'], city: '담양' },
    { keys: ['순천', 'suncheon', '순천만', '국가정원', '낙안읍성', '드라마촬영장'], city: '순천' },
    { keys: ['목포', 'mokpo', '유달산', '해상케이블카', '평화광장', '갓바위', '시화골목'], city: '목포' },
    { keys: ['보성', 'boseong', '녹차밭', '대한다원', '율포해변'], city: '보성' },
    { keys: ['태안', 'taean', '안면도', '꽃지해수욕장', '청산수목원', '천리포수목원'], city: '태안' },
    { keys: ['평창', 'pyeongchang', '대관령', '양떼목장', '월정사', '삼양목장', '알펜시아'], city: '평창' },
    { keys: ['원주', 'wonju', '소금산', '출렁다리', '뮤지엄산', '간현관광지'], city: '원주' },
    { keys: ['동해', 'donghae', '묵호항', '추암촛대바위', '망상해변', '도째비골'], city: '동해' },
    { keys: ['삼척', 'samcheok', '장호항', '환선굴', '맹방해변'], city: '삼척' },
    { keys: ['대구', 'daegu', '동성로', '서문시장', '앞산', '김광석거리', '수성못', '이월드'], city: '대구' },
    { keys: ['대전', 'daejeon', '성심당', '유성온천', '엑스포', '한밭수목원', '대청호'], city: '대전' },
    { keys: ['광주', 'gwangju', '충장로', '무등산', '양림동', '아시아문화전당'], city: '광주' },
    { keys: ['울산', 'ulsan', '태화강', '대왕암', '간절곶', '십리대숲', '장생포'], city: '울산' },
    { keys: ['인천', 'incheon', '仁川', '송도', '차이나타운', '월미도', '개항장', '영종도', '센트럴파크'], city: '인천' },
    { keys: ['서울', 'seoul', 'ソウル', '首尔', '首爾', '성수', '한남', '홍대', '강남', '명동', '종로', '익선동', '이태원', '잠실', '여의도', '도산', '압구정', '하이브', '용산', '북촌', '인사동', '청와대', '남산', '광화문', '동대문', '코엑스'], city: '서울' }
  ];
