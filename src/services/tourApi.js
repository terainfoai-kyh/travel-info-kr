...
// 🌐 전국 지자체 표준 다국어(영문/일문/중문) 동적 사전 (전국 17개 시·도 및 226개 시·군·구 전수 매핑)
export const KOREAN_CITY_I18N = {
  ...
  '군위': { en: 'Gunwi', ja: '軍威', zh: '军威' },
  '달성': { en: 'Dalseong', ja: '達城', zh: '达城' },
  '강화': { en: 'Ganghwa', ja: '江華', zh: '江华' },
  '옹진': { en: 'Ongjin', ja: '甕津', zh: '瓮津' },
  '울주': { en: 'Ulju', ja: '蔚州', zh: '蔚州' },
  '울주군': { en: 'Ulju-gun', ja: '蔚州郡', zh: '蔚州郡' },

  // 경기도 (31)
  '수원': { en: 'Suwon', ja: '水原', zh: '水原' },
  '용인': { en: 'Yongin', ja: '龍仁', zh: '龙仁' },
  '고양': { en: 'Goyang', ja: '高陽', zh: '高阳' },
  '성남': { en: 'Seongnam', ja: '城南', zh: '城南' },
  '화성': { en: 'Hwaseong', ja: '華城', zh: '华城' },
  '부천': { en: 'Bucheon', ja: '富川', zh: '富川' },
  '남양주': { en: 'Namyangju', ja: '南楊州', zh: '南杨州' },
  '안산': { en: 'Ansan', ja: '安山', zh: '安山' },
  '평택': { en: 'Pyeongtaek', ja: '平沢', zh: '平泽' },
  '안양': { en: 'Anyang', ja: '安養', zh: '安养' },
  '시흥': { en: 'Siheung', ja: '始興', zh: '始兴' },
  '파주': { en: 'Paju', ja: '坡州', zh: '坡州' },
  '김포': { en: 'Gimpo', ja: '金浦', zh: '金浦' },
  '의정부': { en: 'Uijeongbu', ja: '議政府', zh: '议政府' },
  '하남': { en: 'Hanam', ja: '河南', zh: '河南' },
  '광명': { en: 'Gwangmyeong', ja: '光明', zh: '光明' },
  '군포': { en: 'Gunpo', ja: '軍浦', zh: '军浦' },
  '양주': { en: 'Yangju', ja: '楊州', zh: '杨州' },
  '오산': { en: 'Osan', ja: '烏山', zh: '乌山' },
  '이천': { en: 'Icheon', ja: '利川', zh: '利川' },
  '안성': { en: 'Anseong', ja: '安城', zh: '安城' },
  '구리': { en: 'Guri', ja: '九里', zh: '九里' },
  '포천': { en: 'Pocheon', ja: '抱川', zh: '抱川' },
  '의왕': { en: 'Uiwang', ja: '義王', zh: '义王' },
  '양평': { en: 'Yangpyeong', ja: '楊平', zh: '杨平' },
  '여주': { en: 'Yeoju', ja: '驪州', zh: '骊州' },
  '동두천': { en: 'Dongducheon', ja: '東豆川', zh: '东豆川' },
  '가평': { en: 'Gapyeong', ja: '加平', zh: '加平' },
  '과천': { en: 'Gwacheon', ja: '果川', zh: '果川' },
  '연천': { en: 'Yeoncheon', ja: '漣川', zh: '涟川' },
  ...
  '홍천': { en: 'Hongcheon', ja: '洪川', zh: '洪川' },
  '횡성': { en: 'Hoengseong', ja: '横城', zh: '横城' },
  '영월': { en: 'Yeongwol', ja: '寧越', zh: '宁越' },
  '평창': { en: 'Pyeongchang', ja: '平昌', zh: '平昌' },
  '정선': { en: 'Jeongseon', ja: '旌善', zh: '旌善' },
  '철원': { en: 'Cheorwon', ja: '鉄原', zh: '铁原' },
  '화천': { en: 'Hwacheon', ja: '華川', zh: '华川' },
  '양구': { en: 'Yanggu', ja: '楊口', zh: '杨口' },
  '인제': { en: 'Inje', ja: '麟蹄', zh: '麟蹄' },
  '고성': { en: 'Goseong', ja: '高城', zh: '高城' },
  '고성(강원)': { en: 'Goseong', ja: '高城', zh: '高城' },
  '양양': { en: 'Yangyang', ja: '襄陽', zh: '襄阳' },

  // 충청북도 (11)
  '청주': { en: 'Cheongju', ja: '清州', zh: '清州' },
  '충주': { en: 'Chungju', ja: '忠州', zh: '忠州' },
  '제천': { en: 'Jecheon', ja: '堤川', zh: '堤川' },
  '보은': { en: 'Boeun', ja: '報恩', zh: '报恩' },
  '옥천': { en: 'Okcheon', ja: '沃川', zh: '沃川' },
  '영동': { en: 'Yeongdong', ja: '永同', zh: '永同' },
  '증평': { en: 'Jeungpyeong', ja: '曽坪', zh: '曾坪' },
  '진천': { en: 'Jincheon', ja: '鎮川', zh: '镇川' },
  '괴산': { en: 'Goesan', ja: '槐山', zh: '槐山' },
  '음성': { en: 'Eumseong', ja: '陰城', zh: '阴城' },
  '단양': { en: 'Danyang', ja: '丹陽', zh: '丹阳' },

  // 충청남도 (15)
  '천안': { en: 'Cheonan', ja: '天安', zh: '天安' },
  '공주': { en: 'Gongju', ja: '公州', zh: '公州' },
  '보령': { en: 'Boryeong', ja: '保寧', zh: '保宁' },
  '아산': { en: 'Asan', ja: '牙山', zh: '牙山' },
  '서산': { en: 'Seosan', ja: '瑞山', zh: '瑞山' },
  '논산': { en: 'Nonsan', ja: '論山', zh: '论山' },
  '계룡': { en: 'Gyeryong', ja: '鶏龍', zh: '鸡龙' },
  '당진': { en: 'Dangjin', ja: '唐津', zh: '唐津' },
  '금산': { en: 'Geumsan', ja: '錦山', zh: '锦山' },
  '부여': { en: 'Buyeo', ja: '扶余', zh: '扶余' },
  '서천': { en: 'Seocheon', ja: '舒川', zh: '舒川' },
  '청양': { en: 'Cheongyang', ja: '青陽', zh: '青阳' },
  '홍성': { en: 'Hongseong', ja: '洪城', zh: '洪城' },
  '예산': { en: 'Yesan', ja: '礼山', zh: '礼山' },
  '태안': { en: 'Taean', ja: '泰安', zh: '泰安' },

  // 전북특별자치도 (14)
  '전주': { en: 'Jeonju', ja: '全州', zh: '全州' },
  '군산': { en: 'Gunsan', ja: '群山', zh: '群山' },
  '익산': { en: 'Iksan', ja: '益山', zh: '益山' },
  '정읍': { en: 'Jeongeup', ja: '井邑', zh: '井邑' },
  '남원': { en: 'Namwon', ja: '南原', zh: '南原' },
  '김제': { en: 'Gimje', ja: '金堤', zh: '金堤' },
  '완주': { en: 'Wanju', ja: '完州', zh: '完州' },
  '진안': { en: 'Jinan', ja: '鎮安', zh: '镇安' },
  '무주': { en: 'Muju', ja: '茂朱', zh: '茂朱' },
  '장수': { en: 'Jangsu', ja: '長水', zh: '长水' },
  '임실': { en: 'Imsil', ja: '任実', zh: '任实' },
  ...
  '나주': { en: 'Naju', ja: '羅州', zh: '罗州' },
  '광양': { en: 'Gwangyang', ja: '光陽', zh: '光阳' },
  '담양': { en: 'Damyang', ja: '潭陽', zh: '潭阳' },
  '곡성': { en: 'Gokseong', ja: '谷城', zh: '谷城' },
  '구례': { en: 'Gurye', ja: '求礼', zh: '求礼' },
  '고흥': { en: 'Goheung', ja: '高興', zh: '高兴' },
  '보성': { en: 'Boseong', ja: '宝城', zh: '宝城' },
  '화순': { en: 'Hwasun', ja: '和順', zh: '和顺' },
  '장흥': { en: 'Jangheung', ja: '長興', zh: '长兴' },
  '강진': { en: 'Gangjin', ja: '康津', zh: '康津' },
  '해남': { en: 'Haenam', ja: '海南', zh: '海南' },
  '영암': { en: 'Yeongam', ja: '霊岩', zh: '灵岩' },
  '무안': { en: 'Muan', ja: '務安', zh: '务安' },
  '함평': { en: 'Hampyeong', ja: '咸平', zh: '咸平' },
  '영광': { en: 'Yeonggwang', ja: '霊光', zh: '灵光' },
  '장성': { en: 'Jangseong', ja: '長城', zh: '长城' },
  ...
  '구미': { en: 'Gumi', ja: '亀尾', zh: '龟尾' },
  '영주': { en: 'Yeongju', ja: '栄州', zh: '荣州' },
  '영천': { en: 'Yeongcheon', ja: '永川', zh: '永川' },
  '상주': { en: 'Sangju', ja: '尚州', zh: '尚州' },
  '문경': { en: 'Mungyeong', ja: '聞慶', zh: '闻庆' },
  '경산': { en: 'Gyeongsan', ja: '慶山', zh: '庆山' },
  '의성': { en: 'Uiseong', ja: '義城', zh: '义城' },
  '청송': { en: 'Cheongsong', ja: '青松', zh: '青松' },
  '영양': { en: 'Yeongyang', ja: '英陽', zh: '英阳' },
  '영덕': { en: 'Yeongdeok', ja: '盈徳', zh: '盈德' },
  '청도': { en: 'Cheongdo', ja: '清道', zh: '清道' },
  '고령': { en: 'Goryeong', ja: '高霊', zh: '高灵' },
  '성주': { en: 'Seongju', ja: '星州', zh: '星州' },
  '칠곡': { en: 'Chilgok', ja: '漆谷', zh: '漆谷' },
  '예천': { en: 'Yecheon', ja: '醴泉', zh: '醴泉' },
  '봉화': { en: 'Bonghwa', ja: '奉化', zh: '奉化' },
  '울진': { en: 'Uljin', ja: '蔚珍', zh: '蔚珍' },
  '울릉': { en: 'Ulleungdo', ja: '鬱陵島', zh: '郁陵岛' },
  '울릉도': { en: 'Ulleungdo', ja: '鬱陵島', zh: '郁陵岛' },
  ...
  '양산': { en: 'Yangsan', ja: '梁山', zh: '梁山' },
  '의령': { en: 'Uiryeong', ja: '宜寧', zh: '宜宁' },
  '함안': { en: 'Haman', ja: '咸安', zh: '咸安' },
  '창녕': { en: 'Changnyeong', ja: '昌寧', zh: '昌宁' },
  '고성(경남)': { en: 'Goseong', ja: '固城', zh: '固城' },
  '남해': { en: 'Namhae', ja: '南海', zh: '南海' },
  '하동': { en: 'Hadong', ja: '河東', zh: '河东' },
  '산청': { en: 'Sancheong', ja: '山清', zh: '山清' },
...
// 한국관광공사 TourAPI 4.0 - 위치기반 관광정보조회 (/locationBasedList2)
export async function fetchLocationBasedTourApiSpots(lat, lng, radius = 20000, lang = 'ko') {
  if (!lat || !lng) return [];
  let apiBase = PUBLIC_API_CONFIG.TOUR_API_BASE || 'https://apis.data.go.kr/B551011/KorService2';
  if (lang === 'en') apiBase = PUBLIC_API_CONFIG.ENG_BASE;
  else if (lang === 'ja') apiBase = PUBLIC_API_CONFIG.JPN_BASE;
  ...
  try {
    const url = `${apiBase}/locationBasedList2?serviceKey=${PUBLIC_API_CONFIG.SERVICE_KEY}&MobileOS=ETC&MobileApp=KTravelApp&_type=json&mapX=${lng}&mapY=${lat}&radius=${radius}&arrange=P&numOfRows=20&pageNo=1`;
    const res = await fetch(url);
    if (!res.ok) return [];
    const data = await res.json();
    const itemsRaw = data.response?.body?.items?.item || [];
    ...
    return items.map(item => ({
      ...
      image: item.firstimage || item.firstimage2 || null,
      addr1: item.addr1 || '',
      dataSource: 'TOUR_API_LOCATION_BASED'
    }));
  } catch {
    return [];
  }
