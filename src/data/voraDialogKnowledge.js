...
export const CITY_LOCAL_KNOWLEDGE = {
  ...
  '진주': {
    ...
    nameJa: '晋州',
    nameZh: '晋州',
    badge: '진주성과 남강 유등축제의 충절과 역사가 깃든 천년고도',
    signatureHighlights: ['진주성 & 촉석루', '국립진주박물관', '남강 유등 테마공원 & 물빛나루쉼터', '진양호 전망대 & 물빛갤러리'],
    rainyHotspots: ['국립진주박물관 (임진왜란 전문 국립박물관)', '진주익룡발자국전시관', '진주청동기문화박물관', '경남문화예술회관'],
    walkingMinimized: ['남강 김시민호 유람선', '촉석루 평지 누각 쉼터', '진주성 성곽 평지 산책', '진양호 물빛나루 테라스'],
    localFoodieSecret: '진주 칠암동 70년 전통 육회비빔밥(천황식당/제일식당), 진주 하연옥 육전 냉면, 진주 꿀빵, 땡초김밥',
    transitTip: '서울역/수서역에서 KTX/SRT 탑승 시 진주역까지 2시간 15분 직통',
    nightHighlights: [
      { name: '진주성 & 촉석루 남강 야경', desc: '남강 물결 위에 찬란하게 반사되는 진주성 누각과 은은한 성곽 불빛 파노라마' }
    ]
  },
  '창원': {
    ...
    nameJa: '昌原',
    nameZh: '昌原',
    badge: '진해 벚꽃과 로망스다리, 마산 해양드라마세트장의 남해안 중심지',
    signatureHighlights: ['진해 여좌천 로망스다리 & 경화역 벚꽃길', '마산 해양드라마세트장', '창원의 집 (한옥 정원)', '저도 연륙교 (콰이강의 다리 스카이워크)'],
    rainyHotspots: ['창원시립마산문신미술관', '경남도립미술관', '진해해양공원 해양생물테마파크'],
    walkingMinimized: ['진해 제황산 모노레일', '여좌천 평지 데크 산책로', '콰이강의 다리 유리전망대 쉼터'],
    localFoodieSecret: '마산 아구찜 & 미더덕 덮밥, 진해 제과 벚꽃빵, 마산 통술거리 해산물 만찬',
    transitTip: '서울역에서 KTX 탑승 시 창원중앙역/마산역/진해역까지 2시간 40분 연결'
  },
  '김해': {
    nameEn: 'Gimhae',
    nameJa: '金海',
    nameZh: '金海',
    badge: '가야 500년 왕도의 수로왕릉과 낙동강 레일바이크 와인동굴',
    signatureHighlights: ['국립김해박물관 & 수로왕릉', '김해 낙동강 레일파크 (레일바이크 & 와인동굴)', '클레이아크 김해미술관', '가야테마파크 & 가야무사어드벤처'],
    rainyHotspots: ['국립김해박물관', '클레이아크 미술관 돔하우스', '낙동강 와인동굴 (사계절 쾌적)'],
    walkingMinimized: ['낙동강 레일바이크 평지 코스', '수로왕릉 평지 솔밭 산책', '가야테마파크 모노레일'],
    localFoodieSecret: '김해 동상시장 칼국수타운, 김해 뒷고기 숯불구이, 진영 단감빵 & 단감와인',
    transitTip: '부산김해경전철로 김해공항 및 부산 사상역에서 30분 직통 연결'
  },
  '문경': {
    nameEn: 'Mungyeong',
    nameJa: '聞慶',
    nameZh: '闻庆',
    badge: '조선 선비들의 과거길 문경새재와 오미자 향기 가득한 힐링 고장',
    signatureHighlights: ['문경새재 도립공원 (1·2·3관문 & 오픈세트장)', '문경 오미자테마터널 & 진남교반', '문경 에코랄라 (가은오픈세트장 & 석탄박물관)', '문경철로자전거'],
    rainyHotspots: ['문경석탄박물관', '문경도자기박물관', '오미자테마터널 (사계절 15도 유지)', '에코타운 실내 에코플라자'],
    walkingMinimized: ['문경새재 전동차 투어', '진남교반 오션뷰 카페', '에코랄라 모노레일', '가은역 레트로 찻집'],
    localFoodieSecret: '문경 약돌돼지 삼겹살·석쇠구이, 오미자 막걸리 & 와인, 문경 뉴욕제과 찹쌀떡, 올갱이국',
    transitTip: '중부내륙고속도로 문경/점촌IC, KTX-이음 문경역 개통으로 수도권 1시간대 진입',
    nightHighlights: [
      { name: '진남교반 & 오미자터널 야경', desc: '경북 팔경 1위 진남교반 불빛 조명과 환상적인 오미자 빛터널' }
    ]
  },
  '거창': {
    nameEn: 'Geochang',
    nameJa: '居昌',
    nameZh: '居昌',
    badge: '수승대 명경지수와 감악산 보랏빛 아스타국화의 청정 쉼터',
    signatureHighlights: ['거창 수승대 (거북바위·출렁다리·요수정)', '거창 창포원 (국가정원 수변생태공원)', '감악산 풍력발전단지 & 아스타국화 언덕', '우두산 Y자형 출렁다리'],
    rainyHotspots: ['거창박물관', '거창창포원 열대식물원 실내온실', '항노화힐링랜드 산림치유센터'],
    walkingMinimized: ['창포원 무장애 수변 데크길', '우두산 힐링랜드 무장애 데크로드', '수승대 수변 벤치 쉼터'],
    localFoodieSecret: '거창 애우(고품격 거창한우), 거창 사과빵 & 사과파이, 어탕국수, 메밀묵밥',
    transitTip: '광주대구고속도로 거창IC 및 대전/대구 터미널에서 직통 시외버스 운행'
  },
  '평창': {
    nameEn: 'Pyeongchang',
    nameJa: '平昌',
    nameZh: '平昌',
    badge: '대관령 푸른 초원과 발왕산 천년주목숲의 알프스 힐링',
    signatureHighlights: ['대관령 양떼목장 & 삼양목장', '발왕산 스카이워크 & 천년주목숲길 케이블카', '오대산 월정사 전나무숲길', '알펜시아 & 용평리조트'],
    rainyHotspots: ['월정사 성보박물관', '발왕산 케이블카 실내 라운지', '대관령 눈꽃마을 실내체험관'],
    walkingMinimized: ['발왕산 케이블카 탑승', '월정사 무장애 전나무숲 데크길', '양떼목장 완만 산책로'],
    localFoodieSecret: '평창 대관령 한우 숯불구이, 봉평 메밀막국수 & 메밀전병, 송어회, 황태구이 정식',
    transitTip: '서울/청량리역에서 KTX-이음 탑승 시 평창역/진부(오대산)역까지 1시간 20분 직통'
  },
  '영월': {
    nameEn: 'Yeongwol',
    nameJa: '寧越',
    nameZh: '宁越',
    badge: '단종의 애사가 서린 청령포와 별마로천문대 밤하늘의 낭만',
    signatureHighlights: ['영월 청령포 (단종 유배지 & 관음송)', '영월 한반도지형 & 뗏목체험', '별마로천문대 야경 & 별자리 관측', '선돌 & 장릉'],
    rainyHotspots: ['영월 아프리카미술박물관', '영월 화석박물관', '별마로천문대 천체투영관', '서부시장 실내 먹거리골목'],
    walkingMinimized: ['청령포 도선(배) 탑승 이동', '한반도지형 전망대 평지 코스', '동강 뷰 테라스 카페'],
    localFoodieSecret: '영월 서부시장 일미닭강정, 메밀전병 & 수수부꾸미, 다슬기해장국, 곤드레밥',
    transitTip: '청량리역에서 무궁화/ITX-마음 탑승 시 영월역까지 1시간 40분 도착'
  },
  '정선': {
    nameEn: 'Jeongseon',
    nameJa: '旌善',
    nameZh: '旌善',
    badge: '정선아리랑의 숨결과 민둥산 은빛 억새의 고원 힐링',
    signatureHighlights: ['정선 5일장 (아리랑시장)', '하이원 스카이1340 & 워터월드', '민둥산 억새군락지', '병방치 스카이워크 & 짚와이어', '화암동굴'],
    rainyHotspots: ['화암동굴 (천연 종유석 & 금광 테마)', '정선아리랑박물관', '하이원 실내 엔터테인먼트'],
    walkingMinimized: ['화암동굴 모노레일', '하이원 곤돌라 투어', '병방치 전망대 엘리베이터', '아리랑시장 평지 골목'],
    localFoodieSecret: '정선 곤드레나물밥, 콧등치기국수, 메밀부치기, 수리취떡, 황기 족발',
    transitTip: '청량리역에서 A-train(정선아리랑열차) 및 KTX 진부역 환승 버스로 연결'
  },
  '동해': {
    nameEn: 'Donghae',
    nameJa: '東海',
    nameZh: '东海',
    badge: '묵호 도째비골 스카이밸리와 추암 촛대바위의 푸른 동해 절경',
    signatureHighlights: ['묵호 도째비골 스카이밸리 & 해랑전망대', '추암 촛대바위 & 출렁다리', '무릉계곡 & 베틀바위', '논골담길 벽화마을'],
    rainyHotspots: ['천곡황금박쥐동굴 (도심 속 천연동굴)', '동해문화예술회관', '묵호등대 실내 전망대'],
    walkingMinimized: ['도째비골 자이언트슬라이드/엘리베이터', '추암 해변 평지 데크길', '망상해수욕장 송림 쉼터'],
    localFoodieSecret: '동해 묵호항 활어회 & 대게, 시원한 곰치국, 장칼국수, 논골담길 묵호샌드',
    transitTip: '서울/청량리역에서 KTX-이음 탑승 시 묵호역/동해역까지 2시간 10분 직통'
  },
  '삼척': {
    nameEn: 'Samcheok',
    nameJa: '三陟',
    nameZh: '三陟',
    badge: '한국의 나폴리 장호항과 신비의 환선굴이 빚은 해양 비경',
    signatureHighlights: ['삼척 해양레일바이크', '장호항 & 삼척 해상케이블카', '대이리 동굴지대 (환선굴 & 대금굴)', '맹방해수욕장 (BTS 앨범 촬영지)'],
    rainyHotspots: ['환선굴/대금굴 동굴 관람', '삼척 동굴신비관', '이사부 사자공원 실내 갤러리'],
    walkingMinimized: ['삼척 해상케이블카', '환선굴 모노레일', '해양레일바이크 전동 어시스트'],
    localFoodieSecret: '삼척 곰치국, 물회, 삼척 대게, 가자미구이 백반, 맹방 사탕수수빵',
    transitTip: '동해역(KTX)에서 삼척 시내 및 장호항까지 버스/택시 20분대 연결'
  },
  '부여': {
    nameEn: 'Buyeo',
    nameJa: '扶余',
    nameZh: '扶余',
    badge: '백제 사비 123년의 로맨스와 궁남지 천년 연꽃의 고도',
    signatureHighlights: ['궁남지 (한국 최초의 인공 인공연못)', '정림사지 5층석탑 & 박물관', '부소산성 (낙화암 & 백화정)', '백마강 황포돛배 & 수륙양용버스'],
    rainyHotspots: ['국립부여박물관 (백제금동대향로 진품)', '정림사지박물관', '백제문화단지 백제역사문화관'],
    walkingMinimized: ['백마강 황포돛배 유람선', '백제문화단지 전동 트램 투어', '궁남지 평지 수변 데크'],
    localFoodieSecret: '부여 연잎밥 정식 & 떡갈비, 장원막국수 편육, 밤뜨래 밤빵',
    transitTip: '공주역(KTX)에서 부여 직통 셔틀 및 서울남부터미널에서 2시간 직행버스 운행'
  },
  '공주': {
    nameEn: 'Gongju',
    nameJa: '公州',
    nameZh: '公州',
    badge: '무령왕릉의 황금 유물과 공산성 금강 야경이 빛나는 백제 웅진성',
    signatureHighlights: ['공산성 (유네스코 세계유산 & 성곽길 야경)', '무령왕릉과 왕릉원', '국립공주박물관', '공주 한옥마을 & 제민천 카페거리'],
    rainyHotspots: ['국립공주박물관 (무령왕릉 출토 황금보물)', '웅진백제역사관', '공주 한옥마을 다도체험관'],
    walkingMinimized: ['공산성 고마열차(관광열차)', '한옥마을 평지 골목', '제민천 감성거리 평지 산책'],
    localFoodieSecret: '공주 알밤빵·알밤라떼, 60년 전통 공주국밥, 매콤한 김피탕(김치피자탕수육), 칼국수',
    transitTip: '용산/수서역에서 KTX/SRT 탑승 시 공주역까지 1시간 도착'
  },
  '보령': {
    nameEn: 'Boryeong',
    nameJa: '保寧',
    nameZh: '保宁',
    badge: '대천해수욕장 머드 힐링과 서해안 보령해저터널의 해양 랜드마크',
    signatureHighlights: ['대천해수욕장 & 스카이바이크·짚트랙', '보령머드테마파크 & 머드스파', '무창포해수욕장 신비의 바닷길', '보령해저터널 & 원산도'],
    rainyHotspots: ['보령석탄박물관', '보령머드박물관', '개화예술공원 실내 온실정원 (바둑이네)', '보령해저터널 홍보관'],
    walkingMinimized: ['대천 스카이바이크 전동 구간', '무창포 타워 엘리베이터', '원산도 오션뷰 대형 카페'],
    localFoodieSecret: '대천 조개구이 무한리필, 키조개 삼합(차돌·키조개·전복), 천북 굴단지 굴구이, 꽃게탕',
    transitTip: '용산역에서 서해금빛열차/무궁화 탑승 시 대천역까지 2시간 10분 도착'
  },
  '제천': {
    nameEn: 'Jecheon',
    nameJa: '堤川',
    nameZh: '堤川',
    badge: '청풍호반 케이블카와 의림지 수변 데크의 치유 힐링 도시',
    signatureHighlights: ['청풍호반 케이블카 (비봉산 정상 파노라마)', '의림지 & 용추폭포 유리전망대', '청풍문화재단지 & 모노레일', '배론성지'],
    rainyHotspots: ['제천 한방엑스포공원 실내전시관', '의림지 역사박물관', '청풍호 실내 카페 라운지'],
    walkingMinimized: ['청풍호반 케이블카 크리스탈 캐빈', '비봉산 정상 무장애 데크', '의림지 솔밭 평지 산책'],
    localFoodieSecret: '제천 중앙시장 빨간오뎅, 약채락 비빔밥, 덩실분식 찹쌀떡 & 링도넛, 제천 황기 백숙',
    transitTip: '청량리역에서 KTX-이음 탑승 시 제천역까지 1시간 5분 쾌속 도착'
  },
  '충주': {
    nameEn: 'Chungju',
    nameJa: '忠州',
    nameZh: '忠州',
    badge: '활옥동굴 투명카약과 중앙탑 사적공원이 흐르는 남한강 물길',
    signatureHighlights: ['충주 활옥동굴 (투명카약 & 빛축제)', '중앙탑 사적공원 & 탄금호 무지개길', '탄금대 & 열두대', '충주호 관광선'],
    rainyHotspots: ['활옥동굴 (사계절 12도 쾌적)', '충주박물관', '세계무술박물관'],
    walkingMinimized: ['활옥동굴 평지 관람로', '탄금호 유람선', '중앙탑 수변 평지 잔디밭'],
    localFoodieSecret: '충주 사과돈까스 & 사과빵, 꿩요리 코스, 중앙탑 메밀치킨 & 막국수',
    transitTip: '판교역에서 KTX-이음 탑승 시 충주역까지 40분대 직통 연결'
  },
  '담양': {
    nameEn: 'Damyang',
    nameJa: '潭陽',
    nameZh: '潭阳',
    badge: '죽녹원 청량한 대나무숲과 메타세쿼이아길의 초록빛 힐링',
    signatureHighlights: ['죽녹원 (대나무 숲길 & 운수대통길)', '메타세쿼이아랜드 & 메타프로방스', '관방제림 (300년 거목 숲)', '소쇄원 (조선 정원의 백미)'],
    rainyHotspots: ['담양 한국대나무박물관', '딜라이트 담양 (몰입형 미디어아트 전시관)', '메타프로방스 실내 카페타운'],
    walkingMinimized: ['관방제림 평지 숲길 산책', '메타프로방스 평지 쇼핑거리', '죽녹원 죽림폭포 테라스 쉼터'],
    localFoodieSecret: '담양 떡갈비 정식 & 대통밥, 담양 국수거리 멸치국수·비빔국수 & 약계란, 죽순회무침',
    transitTip: '광주송정역(KTX)에서 담양 직통 시내버스 311번 탑승 시 40분 도착'
  },
  '보성': {
    nameEn: 'Boseong',
    nameJa: '宝城',
    nameZh: '宝城',
    badge: '대한다원 초록 물결 녹차밭과 율포솔밭해변의 청정 남도',
    signatureHighlights: ['대한다원 제1·2다원 녹차밭', '율포솔밭해변 & 해수녹차센터(스파)', '득량역 추억의 거리', '한국차문화공원'],
    rainyHotspots: ['율포 해수녹차센터 실내 해수온천 스파', '한국차박물관', '보성 봇재 복합문화공간'],
    walkingMinimized: ['대한다원 평지 삼나무 숲길', '율포해변 송림 평지 데크', '봇재 티 라운지'],
    localFoodieSecret: '보성 녹돈(녹차먹인 돼지) 삼겹살, 녹차 떡갈비 정식, 벌교 꼬막 정식, 보성 녹차 아이스크림',
    transitTip: '광주/순천역에서 보성역 경유 무궁화호 및 남도해양열차(S-train) 운행'
  },
  '구례': {
    nameEn: 'Gurye',
    nameJa: '求礼',
    nameZh: '求礼',
    badge: '지리산 노고단 운해와 섬진강 사성암 절벽의 천혜 비경',
    signatureHighlights: ['지리산 노고단 (성삼재 코스)', '천년고찰 화엄사 & 각황전', '오산 사성암 (기암절벽 위 암자)', '구례 산수유마을'],
    rainyHotspots: ['지리산 역사문화관', '구례 자연드림파크 힐링체험관', '화엄사 템플 쉼터'],
    walkingMinimized: ['성삼재 ↔ 노고단 무장애 편안한 길', '사성암 마을 셔틀버스', '섬진강 대나무숲길 평지 산책'],
    localFoodieSecret: '구례 지리산 산채정식, 섬진강 다슬기수제비 & 다슬기회무침, 사찰음식, 산수유 식혜',
    transitTip: '용산역에서 KTX 탑승 시 구례구역까지 2시간 20분 도착'
  },
  '하동': {
    nameEn: 'Hadong',
    nameJa: '河東',
    nameZh: '河东',
    badge: '토지 배경지 최참판댁과 화개장터 십리벚꽃길의 남도 서정',
    signatureHighlights: ['섬진강 화개장터', '최참판댁 & 평사리 들판 (동정호 & 부부송)', '쌍계사 & 십리벚꽃길', '하동 플라이웨이 케이블카 & 짚와이어'],
    rainyHotspots: ['하동 야생차박물관', '박경리문학관', '하동 케이블카 실내 라운지'],
    walkingMinimized: ['하동 케이블카 탑승', '동정호 출렁다리 평지 코스', '화개장터 평지 장터 구경'],
    localFoodieSecret: '하동 섬진강 재첩국 & 재첩회덮밥, 참게가리장국, 하동 야생 녹차 & 매실한과',
    transitTip: '구례구역(KTX) 또는 진주역에서 하동 방면 버스로 30분대 연결'
  },
  '남원': {
    nameEn: 'Namwon',
    nameJa: '南原',
    nameZh: '南原',
    badge: '춘향과 이몽룡의 광한루원과 지리산 바래봉 철쭉의 고장',
    signatureHighlights: ['광한루원 (완월정 & 오작교 야경)', '남원시립김병종미술관', '춘향테마파크 & 모노레일', '지리산 뱀사골 & 바래봉'],
    rainyHotspots: ['남원시립김병종미술관 (숲속 힐링 갤러리 & 미안커피)', '국립민속국악원', '판소리체험관'],
    walkingMinimized: ['광한루원 평지 정원 산책', '춘향모노레일 탑승', '요천 생태습지공원'],
    localFoodieSecret: '원조 남원 추어탕 & 미꾸리튀김, 지리산 흑돼지 구이, 남원 막걸리 & 한정식',
    transitTip: '용산역/수서역에서 KTX/SRT 탑승 시 남원역까지 1시간 50분 도착'
  },
  '목포': {
    nameEn: 'Mokpo',
    nameJa: '木浦',
    nameZh: '木浦',
    badge: '국내 최장 해상케이블카와 근대역사문화거리의 낭만 항구',
    signatureHighlights: ['목포 해상케이블카 (유달산 ↔ 고하도 3.23km)', '고하도 해안데크길 & 용머리', '근대역사관 1·2관 (호텔 델루나 촬영지)', '평화광장 춤추는 바다분수 & 갓바위'],
    rainyHotspots: ['목포 근대역사관', '국립해양문화재연구소 해양유물전시관', '목포자연사박물관'],
    walkingMinimized: ['해상케이블카 크리스탈 캐빈', '갓바위 해상 보도교 평지 산책', '평화광장 카페거리'],
    localFoodieSecret: '목포 9미 (꽃게무침·꽃게살비빔밥, 낙지탕탕이, 홍어삼합, 민어회, 중깐 짜장면)',
    transitTip: '용산/수서역에서 KTX/SRT 탑승 시 목포역까지 2시간 15분 종점 직통'
  },
  '영덕': {
    nameEn: 'Yeongdeok',
    nameJa: '盈徳',
    nameZh: '盈德',
    badge: '강구항 대게거리와 쪽빛 동해 바다 블루로드의 해안 절경',
    signatureHighlights: ['강구항 영덕대게거리 & 해파랑공원', '영덕 풍력발전단지 & 정크트릭아트', '창포말등대 & 블루로드 B코스', '괴시리 전통마을'],
    rainyHotspots: ['영덕 신재생에너지전시관', '영덕어촌민속전시관', '정크트릭아트보물섬'],
    walkingMinimized: ['해파랑공원 평지 광장', '창포말등대 전망 데크', '강구항 대게식당 오션뷰'],
    localFoodieSecret: '영덕 박달대게 코스 요리, 대게딱지 볶음밥, 대게라면, 물가자미회무침',
    transitTip: '포항역(KTX)에서 동해선 열차 탑승 시 강구역/영덕역까지 30분대 연결'
  },
  '울진': {
    nameEn: 'Uljin',
    nameJa: '蔚珍',
    nameZh: '蔚珍',
    badge: '죽변 해안스카이레일과 덕구 온천의 청정 동해 힐링',
    signatureHighlights: ['죽변 해안스카이레일 & 폭풍속으로 세트장', '성류굴 (천연기념물 지하동굴)', '덕구온천 스파월드 (국내 유일 자연용출온천)', '왕피천 케이블카 & 아쿠아리움'],
    rainyHotspots: ['울진 국립해양과학관 (해중전망대)', '성류굴 (사계절 15도)', '덕구온천 실내 스파'],
    walkingMinimized: ['죽변 해안스카이레일 자동 주행 캐빈', '왕피천 케이블카', '은어다리 평지 산책'],
    localFoodieSecret: '울진 죽변항 후포항 붉은대게, 문어숙회, 해물비빔짬뽕, 대게빵',
    transitTip: '강릉/포항 터미널에서 직통 시외버스 운행 및 동해선 철도 연계'
  },
  '밀양': {
    nameEn: 'Miryang',
    nameJa: '密陽',
    nameZh: '密阳',
    badge: '영남루 밀양강 야경과 위양지 이팝나무 물그림자의 감성 도시',
    signatureHighlights: ['밀양 영남루 (보물 & 밀양강 뷰)', '위양지 (이팝나무 숲 & 완재정)', '밀양 트윈터널 빛축제', '얼음골 & 얼음골 케이블카'],
    rainyHotspots: ['트윈터널 (폐터널 빛테마파크)', '밀양아리랑우주천문대', '국립밀양기상과학관'],
    walkingMinimized: ['얼음골 케이블카', '영남루 평지 마루 쉼터', '위양지 평지 둘레길'],
    localFoodieSecret: '원조 밀양 돼지국밥, 밀양 한천 젤리 & 디저트, 얼음골 사과빵, 민물장어구이',
    transitTip: '서울역에서 KTX 탑승 시 밀양역까지 2시간 15분 직통'
  },
  '청도': {
    nameEn: 'Cheongdo',
    nameJa: '清道',
    nameZh: '清道',
    badge: '감와인 익어가는 와인터널과 프로방스 빛축제의 낭만',
    signatureHighlights: ['청도 와인터널 (감와인 시음 & 빛 조형물)', '청도 프로방스 포토랜드', '운문사 & 솔바람길', '청도소싸움테마파크 & 루지체험'],
    rainyHotspots: ['청도 와인터널 (연중 15도 유지)', '청도소싸움미디어체험관', '청도 신화랑풍류마을'],
    walkingMinimized: ['와인터널 평지 보도', '운문사 무장애 솔바람길', '군파크루지 리프트 탑승'],
    localFoodieSecret: '청도 한재 미나리 삼겹살, 청도 감말랭이 & 감와인, 웅치기 닭조림, 청도 추어탕',
    transitTip: '동대구역(KTX)에서 무궁화/ITX 탑승 시 청도역까지 25분 쾌속 진입'
  },
  '파주': {
    nameEn: 'Paju',
    nameJa: '坡州',
    nameZh: '坡州',
    badge: '헤이리 예술마을과 출판도시, 평화의 염원이 깃든 임진각',
    signatureHighlights: ['헤이리 예술마을 & 카페거리', '임진각 평화누리 (바람의 언덕 & 곤돌라)', '마장호수 출렁다리 & 수상데크', '파주 출판도시 & 지혜의숲'],
    rainyHotspots: ['파주 지혜의숲 도서관', '헤이리 실내 갤러리 & 한국근현대사박물관', '국립민속박물관 파주관'],
    walkingMinimized: ['임진각 평화 곤돌라', '마장호수 무장애 수변 데크', '지혜의숲 서가 쉼터'],
    localFoodieSecret: '파주 장단콩 정식 & 콩비지, 임진강 황복 & 장어구이, 도너츠 & 마늘빵 (류재은베이커리)',
    transitTip: '서울 합정역에서 광역버스 2200번 탑승 시 헤이리/출판도시 35분 도착'
  },
  '포천': {
    nameEn: 'Pocheon',
    nameJa: '抱川',
    nameZh: '抱川',
    badge: '에메랄드빛 천주호 아트밸리와 산정호수의 사계절 힐링',
    signatureHighlights: ['포천 아트밸리 (천주호 & 모노레일)', '산정호수 & 명성산 억새', '포천 허브아일랜드 (산타마을 & 불빛동화축제)', '국립수목원 (광릉숲)'],
    rainyHotspots: ['포천아트밸리 천문과학관', '허브아일랜드 힐링센터 & 온실', '한가원 (한과문화박물관)'],
    walkingMinimized: ['아트밸리 모노레일', '산정호수 수변 데크 평지길', '허브아일랜드 트랙터 기차'],
    localFoodieSecret: '포천 이동갈비(소갈비 숯불구이) & 이동 막걸리, 파주골 순두부 정식, 메밀 쌈밥',
    transitTip: '서울 강남/잠실에서 포천 직행 광역버스로 1시간 내외 진입'
  },
  '가평': {
    nameEn: 'Gapyeong',
    nameJa: '加平',
  ...
  '양평': {
    ...
    nameJa: '楊平',
    nameZh: '杨平',
    badge: '두물머리 물안개 핫도그와 세미원 연꽃정원의 남한강 낭만',
    signatureHighlights: ['양평 두물머리 (느티나무 & 연핫도그)', '세미원 (물과 꽃의 정원 & 배다리)', '용문사 천년 은행나무', '구둔역 폐역 & 레일바이크'],
    rainyHotspots: ['이함캠퍼스 복합문화공간', '양평군립미술관', '세미원 연꽃박물관'],
    walkingMinimized: ['두물머리 평지 강변길', '세미원 무장애 데크 산책로', '용문산 관광단지 쉼터'],
    localFoodieSecret: '양평 신내서울해장국(원조 선지해장국), 두물머리 연잎 핫도그, 옥천 냉면 & 완자, 용문산 산채정식',
    transitTip: '경의중앙선 양수역/용문역 및 KTX 양평역으로 청량리에서 25분 쾌속 연결'
  },
  '원주': {
    nameEn: 'Wonju',
    nameJa: '原州',
  ...
  '순천': {
    ...
    signatureHighlights: ['순천만 국가정원 & 순천만 습지', '낙안읍성 민속마을 & 선암사', '순천 드라마촬영장 & 와온해변 일몰'],
  ...
  '울주': {
    ...
    nameJa: '蔚州',
    nameZh: '蔚州',
    badge: '한반도 가장 빠른 일출 간절곶과 영남알프스 억새평원의 대자연',
    signatureHighlights: ['간절곶 (대한민국 육지에서 가장 먼저 뜨는 해 & 소망우체통)', '영남알프스 간월재 & 신불산 억새평원', '국보 반구대 암각화 & 천전리 명문', '자수정동굴나라 & 외고산 옹기마을'],
    rainyHotspots: ['자수정동굴나라 (사계절 쾌적한 동굴 보트체험)', '외고산 옹기박물관 & 옹기만들기 체험', '울주민속박물관 & 천전리공룡발자국 화석관'],
    walkingMinimized: ['간절곶 해안 평지 데크 & 카페 테라스', '자수정동굴나라 동굴 보트 투어', '외고산 옹기마을 평지 산책', '등억온천단지 프라이빗 스파'],
    localFoodieSecret: '언양 불고기(원조 한우 떡갈비 구이), 봉계 한우 숯불구이, 간절곶 해빵, 서생 배 젤라또, 언양 미나리 삼겹살',
    transitTip: '울산역(KTX/SRT)이 울주군 삼남읍에 위치하여 서울/수서에서 2시간 직통 도착! 통도사 및 언양 방면 버스 10분 연결'
  },
  '울산': {
    nameEn: 'Ulsan',
    nameJa: '蔚山',
    nameZh: '蔚山',
    badge: '태화강 십리대숲과 대왕암 출렁다리가 빚어낸 도심 생태 힐링',
    signatureHighlights: ['태화강 국가정원 & 십리대숲 은하수길', '대왕암공원 & 해상 출렁다리', '장생포 고래문화마을 & 모노레일', '슬도 & 방어진항 일몰'],
    rainyHotspots: ['장생포 고래박물관 & 고래생태체험관', '울산시립미술관', '울산과학관 & 테마 전시실'],
    walkingMinimized: ['태화강 국가정원 전동 관람차', '장생포 모노레일 투어', '대왕암 해안 데크 평지 산책', '슬도 방파제 무장애길'],
    localFoodieSecret: '언양 불고기, 장생포 고래고기/해물탕, 방어진 활어회 & 물회, 태화강 십리대숲 대나무 라떼',
    transitTip: '울산역(KTX) 및 태화강역(동해선 광역전철)으로 부산 해운대에서 30분대 쾌속 이동'
  }
};
