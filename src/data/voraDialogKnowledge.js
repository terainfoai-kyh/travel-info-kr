...
export const CITY_LOCAL_KNOWLEDGE = {
  ...
  '수원': {
    ...
    nameJa: '水原',
    nameZh: '水原',
    badge: '정조의 효심과 건축 미학이 살아 숨 쉬는 유네스코 세계유산의 도시',
    signatureHighlights: ['수원화성 & 방화수류정', '화성행궁 & 행리단길', '창룡문 플라잉수원 열기구', '수원 통닭거리 & 왕갈비'],
    rainyHotspots: ['수원시립아이파크미술관', '수원박물관', '스타필드 수원 & 별마당도서관', '화성행궁 유여택'],
    walkingMinimized: ['화성어차(순환 관광열차) 투어', '플라잉수원 계류식 헬륨기구', '행궁동 카페 테라스 쉼터', '창룡문 평지 잔디밭'],
    localFoodieSecret: '50년 전통 수원 왕갈비(가보정/본수원), 남문 통닭거리 가마솥 치킨, 보영만두 쫄면',
    transitTip: '서울역/용산역에서 KTX 30분, 지하철 1호선 및 수인분당선으로 수원역 직통 연결',
    hotelType: 'heritage',
    nightHighlights: [
      { name: '방화수류정 & 용연 야경', desc: '연못에 비치는 조선 성곽 누각의 황홀한 야경과 잔디 피크닉' },
      { name: '창룡문 & 플라잉수원', desc: '150m 상공에서 내려다보는 수원 도심과 불빛 성곽 파노라마' },
      { name: '화성행궁 야간개장 (달빛동행)', desc: '은은한 청사초롱 불빛을 따라 걷는 고궁의 밤 산책' }
    ],
    cafeHighlights: [
      { name: '행궁동 카페거리 (행리단길)', desc: '성곽 돌담길을 따라 늘어선 루프탑 한옥 카페와 공방 거리' }
    ]
  },
  '안동': {
    nameEn: 'Andong',
    nameJa: '安東',
    nameZh: '安东',
    badge: '조선 유교 문화와 선비 정신의 정수가 깃든 한국 헤리티지의 메카',
    signatureHighlights: ['안동 하회마을', '병산서원 & 만대루', '월영교 야경 & 문보트', '도산서원'],
    rainyHotspots: ['유교랜드', '안동시립민속박물관', '하회세계탈박물관', '안동소주 전통음식박물관'],
    walkingMinimized: ['월영교 문보트 / 황포돛배', '하회마을 전동스쿠터 투어', '병산서원 만대루 마루 쉼', '낙동강변 평지 산책'],
    localFoodieSecret: '안동 구시장 찜닭골목, 헛제삿밥, 맘모스베이커리 크림치즈빵, 안동 간고등어 정식',
    transitTip: '청량리역에서 KTX-이음으로 2시간 만에 안동역 도착'
  },
  '대구': {
    nameEn: 'Daegu',
