...
export const SUPPLEMENTAL_CITY_LOCAL_KNOWLEDGE = {
  ...
  '울릉': {
    ...
    lat: 37.4843,
    lng: 130.9056,
    badge: '신비의 화산섬 & 청정 동해 비경',
    badgeEn: 'Mystic Volcanic Island & East Sea Wonder',
    badgeJa: '神秘の火山島＆東海の絶景',
    badgeZh: '神秘火山岛与东海纯净秘境',
    description: '에메랄드빛 동해 한가운데 우뚝 솟은 원시 자연의 화산섬, 나리분지와 관음도, 독도전망대를 품은 신비의 힐링 명소',
    descEn: 'Pristine volcanic island in the East Sea featuring Nari Basin, Gwaneumdo Island, and scenic coastal walking trails.',
    descJa: '東海の中心に浮かぶ原生林と奇岩の火山島、羅里盆地や観音島、海岸遊歩道を巡る神秘の癒し旅',
    descZh: '矗立于东海碧波之中的原始火山秘境，拥有罗里盆地、观音岛与绝美海岸步道的自然奇观',
    signatureHighlights: ['나리분지', '관음도(출렁다리)', '행남해안산책로', '독도전망대케이블카', '봉래폭포', '독도'],
    rainyHotspots: ['독도박물관', '울릉도해양체험관', '도동항 여객선터미널 실내전망대'],
    walkingMinimized: ['독도전망대케이블카', '울릉도 유람선투어', '관음도 엘리베이터'],
    localFoodieSecret: '울릉도 독도새우(도화새우), 따개비칼국수·밥, 명이나물 오삼불고기, 오징어순대와 약소구이',
    localFoodieSecretEn: 'Ulleungdo Dokdo Shrimp, Barnacle Noodle Soup & Rice, Pickled Wild Garlic Pork BBQ, Squid Sundae',
    localFoodieSecretJa: '鬱陵島 独島エビ、タカノハ貝カルグクス、行者にんにくサムギョプサル、イカスンデ',
    localFoodieSecretZh: '郁陵岛 独岛鲜甜海虾、藤壶手擀面与藤壶饭、野生茗荑叶炒鱿鱼五花肉、鱿鱼米肠',
    nightHighlights: ['도동항 촛대바위 야간 조명 산책로', '저동항 오징어잡이 배 어화(漁火) 풍경', '사동항 밤바다 뷰'],
    nightHighlightsEn: ['Dodong Port Candlelight Rock Night Illumination', 'Jeodong Port Squid Fishing Boat Night Glow', 'Sadong Beach Night View'],
    nightHighlightsJa: ['道洞港 奇岩ライトアップ散策路', '低洞港 イカ釣り船の漁火風景', '沙洞港 夜景'],
    nightHighlightsZh: ['道洞港 烛台岩夜间景观步道', '低洞港 捕鱿渔船渔火璀璨夜景', '沙洞港 宁静海滨夜景'],
    transitTip: '포항/후포/강릉/묵호여객선터미널에서 울릉도행 쾌속선 및 크루즈 운항 (사동항/도동항/저동항 도착)',
    transitTipEn: 'Express ferries and cruise ships operate from Pohang, Hupo, Gangneung, and Mukho ports',
    transitTipJa: '浦項・後浦・江陵・墨湖フェリーターミナルから鬱陵島行き高速船運行',
    transitTipZh: '从浦项、后浦、江陵、墨湖客运码头搭乘前往郁陵岛的高速客轮或大型游轮'
  },
  '울릉도': {
    nameKo: '울릉도',
  ...
  '독도': {
    ...
    lat: 37.2427,
    lng: 131.8686,
    badge: '대한민국 동쪽 제일 끝 아름다운 영토',
    badgeEn: 'The Easternmost Beautiful Territory of Korea',
    badgeJa: '大韓民国最東端の美しい領土',
    badgeZh: '大韩民国最东端壮美领土',
    description: '대한민국의 아침을 가장 먼저 여는 국토의 동쪽 끝 섬, 동도와 서도 해식애와 푸른 파도가 빚어낸 숭고한 자연유산',
    descEn: 'The easternmost islands of Korea with majestic sea cliffs, vibrant marine life, and breathtaking sunrises.',
    descJa: '韓国で最も早く朝を迎える最東端の美しい島、東島と西島の海食崖と青い波が織りなす崇高な自然遺産',
    descZh: '迎接韩国清晨第一缕阳光的国土最东端岛屿，东岛与西岛海蚀崖壁与蔚蓝海浪交织的壮丽自然宝藏',
    signatureHighlights: ['독도 동도 선착장', '서도 주민숙소', '촛대바위', '한반도바위', '삼형제굴바위'],
    rainyHotspots: ['독도 접안 불가 시 울릉도 독도박물관 관람'],
    walkingMinimized: ['독도 접안 관람(선착장 일대)', '독도 주변 유람선 해상 관광'],
    localFoodieSecret: '독도새우(도화새우, 꽃새우), 자연산 활어회, 울릉도 산채비빔밥',
    localFoodieSecretEn: 'Authentic Dokdo Sweet Shrimp, Fresh Wild Catch Sashimi, Ulleungdo Mountain Herb Rice',
    localFoodieSecretJa: '独島エビ（トゲザラメエビ）、天然刺身、鬱陵島山菜ビビンバ',
    localFoodieSecretZh: '独岛鲜甜大红虾、纯天然野生刺身、郁陵岛纯净山野菜拌饭',
    nightHighlights: ['울릉도 독도전망대에서 바라보는 동해 달빛 바다 파노라마'],
    nightHighlightsEn: ['East Sea Moonlit Panorama viewed from Dokdo Observatory'],
    nightHighlightsJa: ['鬱陵島・独島展望台から眺める東海の月夜パノラマ'],
    nightHighlightsZh: ['从独岛观景台远眺的东海明月全景'],
    transitTip: '울릉도 사동항/도동항/저동항에서 독도행 여객선 탑승 (편도 약 1시간 40분 소요, 기상 상황 연동)',
    transitTipEn: 'Take passenger ferry from Ulleungdo Sadong/Dodong/Jeodong port (approx. 1h 40m)',
    transitTipJa: '鬱陵島（沙洞・道洞・低洞港）から独島行き定期船利用（片道約1時間40分）',
    transitTipZh: '从郁陵岛沙洞/道洞/低洞港搭乘前往独岛的客轮（单程约1小时40分钟）'
  },
  '신안': {
    nameKo: '신안',
    nameEn: 'Sinan (1004 Islands)',
    nameJa: '新安（1004の島）',
    nameZh: '新安（千岛之郡）',
    lat: 34.8290,
    lng: 126.1080,
    badge: '1004개의 섬 & 보랏빛 퍼플섬',
    badgeEn: '1004 Angel Islands & Purple Island',
    badgeJa: '1004の天使の島＆パープルアイランド',
    badgeZh: '千座天使之岛与浪漫紫色岛',
    description: '천사대교를 건너 보랏빛으로 물든 퍼플섬(반월·박지도), 광활한 태평염전과 흑산도·홍도 비경을 품은 다도해 힐링의 성지',
    descEn: 'County of 1004 islands famous for the magical Purple Island (Banwol & Bakji), UNESCO biosphere mudflats, and Taepyeong Salt Farm.',
    descJa: '千四大橋を渡る紫色のパープル島（半月・朴只島）と広大な太平塩田、黒山島・紅島を抱く癒しの多島海',
    descZh: '跨越千广大桥邂逅梦幻浪漫的紫色岛（半月岛与朴只岛），领略广袤太平盐田与黑山岛、红岛壮美风光的千岛之乡',
    signatureHighlights: ['퍼플섬(반월박지도)', '천사대교', '짱뚱어다리', '태평염전(소금박물관)', '임자도 튤립공원', '흑산도', '홍도'],
    rainyHotspots: ['신안 소금박물관', '세계조개박물관', '1004섬 수석미술관'],
    walkingMinimized: ['퍼플섬 전동카트 투어', '천사대교 드라이브', '태평염전 해양힐링스파'],
    localFoodieSecret: '신안 흑산도 명품 홍어회, 짱뚱어탕, 신안 낙지탕탕이와 천일염 왕새우구이',
    localFoodieSecretEn: 'Sinan Heuksando Fermented Skate, Mudskipper Soup, Fresh Live Octopus, Salt-baked Prawns',
    localFoodieSecretJa: '新安黒山島ガンギエイ刺身、ムツゴロウ汁、タコの踊り食い、天日塩エビ焼き',
    localFoodieSecretZh: '新安黑山岛顶级斑鳐生鱼片、大弹涂鱼汤、鲜活章鱼刺身、天日盐烤大虾',
    nightHighlights: ['천사대교 야간 LED 경관 조명 드라이브', '퍼플섬 퍼플 브릿지 달빛 산책로', '자은도 백길해변 일몰 야경'],
    nightHighlightsEn: ['Cheonsadaegyo Bridge Night Light Show Drive', 'Purple Bridge Moonlit Night Walk', 'Jaeundo Baekgil Beach Sunset'],
    nightHighlightsJa: ['千四大橋ライトアップナイトドライブ', 'パープル橋ムーンライト散歩道', '慈恩島ペッキル海岸の夕景'],
    nightHighlightsZh: ['千广大桥LED梦幻光影夜间兜风', '紫色大桥月下浪漫木栈道', '慈恩岛白吉海滩金色日落'],
    transitTip: '목포역에서 신안 방면(퍼플섬/천사대교) 시내버스 운행 또는 렌터카 드라이브 (흑산도/홍도는 목포여객선터미널 탑승)',
    transitTipEn: 'Take bus from Mokpo Station to Cheonsadaegyo / Purple Island, or rent a car (Ferries to Heuksando from Mokpo Port)',
    transitTipJa: '木浦駅から千四大橋・パープル島行きバス運行またはレンタカー推奨（黒山島・紅島は木浦港から定期船）',
    transitTipZh: '从木浦站搭乘前往千广大桥/紫色岛方向的公交或自驾租车（黑山岛/红岛需在木浦客运码头乘船）'
  },
  '완도': {
    nameKo: '완도',
    nameEn: 'Wando',
    ...
    lat: 34.3110,
    lng: 126.7550,
    badge: '슬로시티 청산도 & 청정 바다수도',
    badgeEn: 'Slow City Cheongsando & Marine Wellness',
    badgeJa: 'スローシティ青山島＆清浄な海の都',
    badgeZh: '慢城青山岛与纯净海洋之都',
    description: '유채꽃과 청보리가 물결치는 아시아 최초 슬로시티 청산도와 고산 윤선도의 보길도 세연정, 청정 해양치유를 만끽하는 남해 힐링 명소',
    descEn: 'Premier coastal resort home to Asia’s first Cittaslow Cheongsando Island, Bogildo Seyeonjeong Garden, and Marine Healing Center.',
    descJa: '菜の花と青麦が揺れるアジア初のスローシティ青山島と甫吉島洗然亭、海洋セラピーが楽しめる南海の癒し拠点',
    descZh: '油菜花与青麦浪漫步的亚洲首座慢城青山岛，诗意盎然的甫吉岛洗然亭与海洋疗愈度假胜地',
    signatureHighlights: ['청산도 슬로길', '완도타워 & 모노레일', '보길도 세연정', '신지도 명사십리해수욕장', '완도 해양치유센터'],
    rainyHotspots: ['완도 해양치유센터(실내 스파치유)', '완도타워 실내전망대', '장보고기념관'],
    walkingMinimized: ['완도 모노레일', '청산도 순환투어버스', '완도 해양치유센터 테라피'],
    localFoodieSecret: '완도 명품 활전복 코스요리(버터구이·물회·죽), 매생이국, 자연산 생선구이 백반',
    localFoodieSecretEn: 'Wando Premium Abalone Course (Butter Grilled & Porridge), Seaweed Fulvescens Soup, Grilled Fish',
    localFoodieSecretJa: '莞島名物 活アワビフルコース（バター焼き・粥・水刺身）、カプサアオノリ汁、焼き魚定食',
    localFoodieSecretZh: '莞岛顶级鲜活鲍鱼盛宴（黄油烤鲍鱼、生鲍鱼冷汤、鲍鱼粥）、海萝汤、炭烤鲜鱼定食',
    nightHighlights: ['완도타워 레이저 미디어쇼 & 다도해 야경', '신지도 명사십리 밤바다 달빛산책', '완도항 해변공원 야경'],
    nightHighlightsEn: ['Wando Tower Night Laser Media Show', 'Myeongsasimni Beach Moonlit Night Walk', 'Wando Port Coastal Park'],
    nightHighlightsJa: ['莞島タワーレーザーショー＆多島海夜景', '鳴沙十里海水浴場ナイトウォーク', '莞島港海辺公園'],
    nightHighlightsZh: ['莞岛塔激光媒体灯光秀与多岛海夜景', '鸣沙十里海滩漫步月色', '莞岛港海滨公园夜景'],
    transitTip: '광주/목포 터미널에서 완도행 직행버스 운행 (청산도/보길도/제주도행은 완도연안여객선터미널 탑승)',
    transitTipEn: 'Direct express buses from Gwangju and Mokpo to Wando (Ferries to Cheongsando/Jeju from Wando Ferry Terminal)',
    transitTipJa: '光州・木浦バスターミナルから莞島行き直行バス運行（青山島・済州島へは莞島港フェリー利用）',
    transitTipZh: '从光州/木浦客运站搭乘前往莞岛的直达巴士（前往青山岛/济州岛在莞岛沿岸客运码头乘船）'
  },
  '진도': {
    nameKo: '진도',
    nameEn: 'Jindo',
    ...
    lng: 126.2630,
    badge: '신비의 바닷길 & 남도 예향',
    badgeEn: 'Miracle Sea Road & Namdo Folk Arts',
    badgeJa: '神秘の海割れ＆南道の芸術郷',
    badgeZh: '神秘海割奇观与南道艺乡',
    description: '바다가 갈라지는 현대판 모세의 기적 신비의 바닷길과 남종화의 산실 운림산방, 세방낙조 낙조 비경을 품은 민속 문화 예술의 섬',
    descEn: 'Culture and nature island famous for the Miracle Sea Road festival, Ullimsanbang art retreat, and Sebang Sunset.',
    descJa: '海が割れる神秘の海割れと南画の聖地・雲林山房、細方落照の絶景夕日を誇る南道の芸術と伝統の島',
    descZh: '现代版摩西奇迹神秘海割奇观、南宗画发源地云林山房与细方落照绝景交相辉映的文化艺术之岛',
    signatureHighlights: ['신비의바닷길', '운림산방', '세방낙조전망대', '진도타워 & 울돌목 명량해상케이블카', '진도개테마파크', '쏠비치 진도'],
    rainyHotspots: ['운림산방 소치기념관', '남도전통미술관', '진도타워 역사체험관'],
    walkingMinimized: ['울돌목 명량해상케이블카', '세방낙조전망대 드라이브', '쏠비치 진도 인피니티풀'],
    localFoodieSecret: '진도 명물 간장꽃게장 & 꽃게탕, 자연산 톳밥, 간장전복장과 진도 홍주(지초주)',
    localFoodieSecretEn: 'Jindo Blue Crab Stew & Marinated Crab, Wild Seaweed Rice, Braised Abalone, Jindo Red Liquor (Hongju)',
    localFoodieSecretJa: '珍島名物 ワタリガニ鍋＆カンジャンケジャン、ひじきご飯、アワビ醤油漬け、伝統紅酒',
    localFoodieSecretZh: '珍岛特色鲜美酱油蟹与辣炖花蟹、野生鹿角菜饭、酱油鲍鱼与珍岛传统红酒',
    nightHighlights: ['진도대교 & 울돌목 레이저 조명 야경', '쏠비치 진도 프로방스 야간 광장 조명', '세방낙조 황금빛 일몰 야경'],
    nightHighlightsEn: ['Jindo Bridge & Uldolmok Strait Laser Lights', 'Sol Beach Jindo Night Plaza', 'Sebang Sunset Golden Glow'],
    nightHighlightsJa: ['珍島大橋＆鳴梁海峡ライトアップ', 'ソルビーチ珍島ナイトイルミネーション', '細方落照の夕景'],
    nightHighlightsZh: ['珍岛大桥与鸣梁海峡夜间璀璨灯光', 'Sol Beach珍岛普罗旺斯风情夜景广场', '细方落照金色余晖'],
    transitTip: '진도대교로 육로 직결 (목포역에서 진도행 직행버스 또는 쏠비치 진도 셔틀버스 운행)',
    transitTipEn: 'Connected by bridge to mainland; direct buses from Mokpo Station and Sol Beach shuttles',
    transitTipJa: '珍島大橋で陸路直結（木浦駅から珍島行き直行バス運行）',
    transitTipZh: '珍岛大桥与陆地直连（木浦站有前往珍岛的直达大巴或度假村接驳车）'
  },
  '백령도': {
    nameKo: '백령도',
    nameEn: 'Baengnyeongdo Island',
    nameJa: '白翎島',
    nameZh: '白翎岛',
    lat: 37.9620,
    lng: 124.6730,
    badge: '서해 최북단 기암절벽 비경',
    badgeEn: 'Northernmost West Sea Cliffs Wonder',
    badgeJa: '西海最北端の奇岩絶壁の秘境',
    badgeZh: '西海最北端奇岩绝壁秘境',
    description: '서해의 해금강이라 불리는 웅장한 두무진 기암절벽과 전 세계 2곳뿐인 천연비행장 사곶해변, 콩돌해안을 품은 천혜의 섬',
    descEn: 'Northernmost island famous for the dramatic Dumujin sea cliffs, natural airfield Sagot Beach, and Kongdol Pebble Coast.',
    descJa: '西海の海金剛と呼ばれる壮大な頭武津の奇岩絶壁と天然飛行場サゴッ海岸、丸石海岸が広がる秘境の島',
    descZh: '被誉为西海海金刚的头武津奇岩绝壁，全球仅两处的天然沙滩跑道沙串海滩与卵石海岸交相辉映的世外秘境',
    signatureHighlights: ['두무진 기암절벽(유람선투어)', '사곶사빈(천연비행장 해변)', '콩돌해안', '심청각', '용기포항'],
    rainyHotspots: ['심청각 실내전시관', '백령도 평화기념관'],
    walkingMinimized: ['두무진 유람선 해상관광', '사곶해변 차량 드라이브', '심청각 전망대'],
    localFoodieSecret: '백령도 전통 메밀냉면(까나리액젓 육수), 짠지떡, 성게칼국수와 자연산 뿔소라·해삼',
    localFoodieSecretEn: 'Baengnyeongdo Sandlance Buckwheat Naengmyeon, Salted Kimchi Rice Cake, Sea Urchin Kalguksu',
    localFoodieSecretJa: '白翎島伝統イカナゴ出汁メミル冷麺、チャンジ餅、ウニカルグクス、天然サザエ',
    localFoodieSecretZh: '白翎岛传统玉筋鱼汁荞麦冷面、特色泡菜年糕、海胆手擀面与纯天然野生海螺',
    nightHighlights: ['용기포 신항 방파제 달빛 등대 야경', '두무진 일몰 황금빛 노을 풍경'],
    nightHighlightsEn: ['Yonggipo Port Moonlit Lighthouse Night View', 'Dumujin Golden Sunset Coast'],
    nightHighlightsJa: ['龍機浦港ライトアップ灯台夜景', '頭武津の黄金色サンセット'],
    nightHighlightsZh: ['龙机浦新港月色灯塔夜景', '头武津金色落日绚烂晚霞'],
    transitTip: '인천항 연안여객터미널에서 백령도행 쾌속선 탑승 (편도 약 3시간 40분 ~ 4시간 소요)',
    transitTipEn: 'Take express ferry from Incheon Port Coastal Passenger Terminal (approx. 3h 40m - 4h)',
    transitTipJa: '仁川港沿岸フェリーターミナルから白翎島行き高速船利用（片道約3時間40分〜4時間）',
    transitTipZh: '从仁川港沿岸客运码头搭乘前往白翎岛的高速客轮（单程约3小时40分至4小时）'
  }
};
