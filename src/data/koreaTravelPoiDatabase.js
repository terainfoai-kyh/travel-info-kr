...
export const KOREA_TRAVEL_POI_DB = [
  ...
  // ==============================================================================
  // 12. 강릉 (Gangneung) - 200 OK 검증 TourAPI CDN & 정품 다국어 지원
  // ==============================================================================
  {
    id: 'kt_gn_ojukheon',
    title: '오죽헌',
    ...
    city: '강릉',
    category: '명소',
    theme: '조선고택/율곡이이/신사임당',
    duration: 90,
    rating: 4.9,
    image: 'http://tong.visitkorea.or.kr/cms/resource/90/3342090_image2_1.jpg',
    lat: 37.7792,
    lng: 128.8789,
    tags: ['역사', '고택', '보물', '율곡이이', '신사임당', '대표명소'],
    summary: '조선 시대의 대학자 율곡 이이와 신사임당이 태어난 역사 깊은 고택으로, 검은 대나무 숲과 단아한 목조 건축의 미를 간직한 대한민국 보물'
  },
  {
    id: 'kt_gn_gyeongpodae',
    title: '경포대',
    ...
    lat: 37.7952,
    lng: 128.8967,
    tags: ['누각', '관동팔경', '경포호', '풍경', '힐링', '포토존'],
    summary: '거울처럼 맑은 경포호를 내려다보는 관동팔경의 으뜸 누각으로, 하늘과 호수, 바다, 술잔, 님의 눈에 다섯 개의 달이 뜬다는 낭만의 명소'
  },
  {
    id: 'kt_gn_gyeongpobeach',
    title: '경포해변',
    ...
    lat: 37.8055,
    lng: 128.9079,
    tags: ['바다', '해수욕장', '해송림', '일출', '산책', '인생샷'],
    summary: '동해안 최대의 명사십리 백사장과 울창한 해송림이 끝없이 펼쳐지는 강릉 대표 힐링 오션뷰 해변'
  },
  {
    id: 'kt_gn_anmok',
    title: '안목해변 강릉 커피거리',
    ...
    city: '강릉',
    category: '핫플',
    theme: '스페셜티커피/카페거리/오션뷰',
    duration: 90,
    rating: 4.9,
    image: 'http://tong.visitkorea.or.kr/cms/resource/08/3342108_image2_1.jpg',
    lat: 37.7718,
    lng: 128.9482,
    tags: ['커피거리', '카페', '바다전망', '디저트', '순두부젤라또', '데이트'],
    summary: '시원한 에메랄드빛 동해 바다를 바라보며 수준 높은 스페셜티 커피와 순두부 젤라또를 즐길 수 있는 대한민국 1호 커피거리'
  },
  {
    id: 'kt_gn_seongyojang',
    title: '선교장',
    ...
    city: '강릉',
    category: '명소',
    theme: '조선사대부고택/활래정/연못',
    duration: 80,
    rating: 4.8,
    image: 'http://tong.visitkorea.or.kr/cms/resource/89/3342089_image2_1.jpg',
    lat: 37.7865,
    lng: 128.8856,
    tags: ['고택', '활래정', '한옥', '연못', '전통정원', '사진명소'],
    summary: '조선 후기 사대부 가옥의 원형을 완벽하게 보존하고 있는 300년 전통의 고택으로, 연못 위의 활래정과 백일홍의 조화가 빼어난 명소'
  },
  {
    id: 'kt_gn_artemuseum',
    title: '아르떼뮤지엄 강릉',
    ...
    city: '강릉',
    category: '실내',
    theme: '미디어아트/몰입형전시/인생샷',
    duration: 90,
    rating: 4.9,
    image: 'http://tong.visitkorea.or.kr/cms/resource/11/2736111_image2_1.jpg',
    lat: 37.7942,
    lng: 128.8924,
    tags: ['실내', '비오는날', '미디어아트', '인생샷', '전시회', '데이트'],
    summary: '강릉의 바다와 빛을 주제로 한 몰입형 미디어아트 전시관으로, 압도적인 영상미와 웅장한 사운드가 감각적인 감동을 선사하는 핫플'
  },
  {
    id: 'kt_gn_jeongdongjin',
    ...
    city: '강릉',
    category: '명소',
    theme: '바다절벽/유람선리조트/모래시계',
    duration: 100,
    rating: 4.9,
    image: 'http://tong.visitkorea.or.kr/cms/resource/12/3342112_image2_1.jpg',
    lat: 37.6914,
    lng: 129.0345,
    tags: ['정동진', '일출명소', '모래시계', '바다절벽', '썬크루즈', '가족여행'],
    summary: '세계에서 바다와 가장 가까운 간이역 정동진과 해안 절벽 위 호화 유람선 테마 리조트, 거대한 세계 최대 모래시계가 장관을 이루는 랜드마크'
  },
  {
    id: 'kt_gn_haslla',
    title: '하슬라아트월드',
    ...
    city: '강릉',
    category: '실내',
    theme: '조각공원/피노키오박물관/바다포토존',
    duration: 100,
    rating: 4.8,
    image: 'http://tong.visitkorea.or.kr/cms/resource/12/2604812_image2_1.jpg',
    lat: 37.7088,
    lng: 129.0125,
    tags: ['미술관', '조각공원', '포토존', '바다전망', '동그라미포토존', '데이트'],
    summary: '푸른 동해바다를 마주한 3만 3천 평 규모의 복합 문화예술공간으로, 야외 조각공원과 피노키오 박물관, 유명한 바다 액자 동그라미 포토존이 있는 핫플'
  }
];
