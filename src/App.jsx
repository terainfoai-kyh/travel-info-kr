...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'var(--bg-primary)', color: 'var(--text-main)' }}>
      ...
      {/* Main Container - Greenfield AI Standalone Workbench */}
      <main style={{ maxWidth: '1280px', width: '100%', margin: '0 auto', padding: '1rem 1.5rem', flex: 1, position: 'relative', zIndex: 1 }}>
